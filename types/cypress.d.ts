...
export interface CTLMatcherOptions extends Partial<Cypress.Timeoutable>, Partial<Cypress.Loggable> {
...
declare global {
  namespace Cypress {
    ...
    interface Chainable<Subject> {
       ...
       * @see https://github.com/testing-library/dom-testing-library#table-of-contents
       */
      configureCypressTestingLibrary(config: Parameters<typeof configure>[0]): Chainable<void>;
    }
  }
}
